...
_externals = [
  ...
  struct(
    ...
    commit = "170382fa85b10b94728989dfcf6cc818b335c952",importpath = "google.golang.org/appengine/",
  ...
  _github("sourcegraph/jsonrpc2", "b02337b177765febba753be4b7d9c26e3a9fd220"),_github("nelhage/go.cli", "2aeb96ef8025f3646befae8353b90f95e9e79bdc"),
  ...
  struct(
    name = "in_gopkg_alexcesaro_statsd_v2",commit = "7fea3f0d2fab1ad973e641e51dba45443a311a90",
    importpath = "gopkg.in/alexcesaro/statsd.v2",

  ),
  struct(
    name = "in_gopkg_check_v1",
    commit = "20d25e2804050c1cd24a7eea1e7a6447dd0e74ec",importpath = "gopkg.in/check.v1",
